                ...
                columnDefs: [                    
                    {
                        ...
                        render: function render(data, type, row, meta) {
                            return "<a href=\"school-modify.aspx?id=" + row.ID + "\" class=\"mr-1\">" + row.Name + "</a>";                            
                        }
                    },  
                    {
                        targets: 2,
                        render: function render(data, type, row, meta) {
                            if (row.ImageName != '') {
                                return "<img src='/thumb.aspx?path=source/CMSFiles/"+ row.ImageName +"&width=100' width='100' />";
                            }
                            else {
                                return "";
                            }
                    ...
                    },
                    {
                        targets: 4,
                        render: function render(data, type, row, meta) {                            
                            return "<a class='btn btn-sm btn-icon btn-secondary' href='school-modify.aspx?id=" + row.ID + "'><i class=\"fa fa-pencil-alt\"></i></a>";                                
                        }
                    },
                    {
                        targets: 5,
