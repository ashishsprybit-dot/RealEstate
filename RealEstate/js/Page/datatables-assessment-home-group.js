        ...
        value: function table() {
            var initDataTable = $('#myTable').DataTable({
                ...
                columnDefs: [
                    ...
                    //        return "<a href=\"assessment-homegroups/" + row.KGCKEY + ".aspx\" class=\"mr-1\">" + row.KGCKEY + "</a>";
                    //    }
                    //},
                    {
                        targets: 2,
                    ...
                    //},
                    {
                        targets: 3,
                        render: function render(data, type, row, meta) {
                            return "<a style='width:125px;' href=\"assessment-homegroups/" + row.KGCKEY + ".aspx\" class=\"mr-1 btn btn-secondary\">View Result</a>";
