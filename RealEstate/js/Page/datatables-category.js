                ...
                columnDefs: [                   
                    {
                        ...
                        render: function render(data, type, row, meta) {
                            if (row.ParentID == "0") {
                                return "<a href=\"category-modify.aspx?id=" + row.ID + "\" class=\"mr-1\"><b>" + row.TreeLevel + "</b></a>";                            
                            }
                            else {
                                return "<a href=\"category-modify.aspx?id=" + row.ID + "\" class=\"mr-1\">" + row.TreeLevel + "</a>";                               
                            }
                    ...
                    },
                    {
                        ...
                        render: function render(data, type, row, meta) {
                            ...
                            if (row.TreeLevelNo == "3") {
                                return "<a href='question-list.aspx?cid=" + row.ID + "' class='font17'>" + row.Questions +"</a>";
                            }
                            else {
                                return "";
                            }
                    ...
                    },
                    {
                        targets: 3,
                        render: function render(data, type, row, meta) {                            
                            return "<a class='btn btn-sm btn-icon btn-secondary' href='category-modify.aspx?id=" + row.ID + "'><i class=\"fa fa-pencil-alt\"></i></a>";                                
                        }
                    },
                    {
                        targets: 4,
