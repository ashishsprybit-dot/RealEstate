                ...
                columnDefs: [                   
                    {
                        ...
                        render: function render(data, type, row, meta) {
                            return "<a href=\"school-admin-modify.aspx?id=" + row.ID + "\" class=\"mr-1\">" + getFullName(row) + "</a>";                            
                        }
                    },
                    {                        
                        targets: 4,
                    ...
                    },
                    {
                        targets: 5,
                        render: function render(data, type, row, meta) {                            
                            return "<a class='btn btn-sm btn-icon btn-secondary' href='school-admin-modify.aspx?id=" + row.ID + "'><i class=\"fa fa-pencil-alt\"></i></a>";                                
                        }
                    },
                    {
                        targets: 6,
