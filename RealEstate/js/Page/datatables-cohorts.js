                ...
                columnDefs: [                    
                    {
                        ...
                        render: function render(data, type, row, meta) {
                            return "<a href='cohort-modify.aspx?id=" + row.ID + "' class=\"mr-1\">" + row.Name + "</a>";                            
                        }
                    },
                    {
                        targets: 2,
                        render: function render(data, type, row, meta) {
                            return "<a data-toggle='tooltip' data-placement='bottom' title='Edit' class='btn btn-sm btn-icon btn-secondary' href='cohort-modify.aspx?id=" + row.ID + "'><i class=\"fa fa-pencil-alt\"></i></a>";
                        }
                    },
                    {
                        targets: 3,
