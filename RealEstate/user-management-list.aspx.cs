...
public partial class Main_Teacher_List : System.Web.UI.Page
{
    ...
    UserManagementBAL objUserManagement = new UserManagementBAL();
    public string data = "";
    ...
    {
        objUserManagement.FirstName = Request["tbxFname"];
        objUserManagement.LastName = Request["tbxLname"];
        objUserManagement.EmailID = Request["tbxEmail"];
        int intTotalRecord = 0;
        DataTable dt = new DataTable();
        int CurrentPage = 1;
        dt = objUserManagement.GetList(ref CurrentPage, 100000, out intTotalRecord, "ID", "ASC", SchoolURL);
