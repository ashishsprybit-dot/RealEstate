<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="teacher-modify.aspx.cs"
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHContent" runat="Server">
    <header class="page-title-bar">
        <h1 class="page-title"><span id="spnHeader" runat="server">Add Teacher</span></h1>
    ...
    <div class="page-section" data-select2-id="166">
        ...
        <div class="card-deck-xl">
            ...
            <div class="card card-fluid" data-select2-id="165">
                ...
                <form id="form_Admin" action="teacher-modify.aspx?id=<%=ID%>" method="post" target="ifrmForm"
                    ...
                    <div class="card-body border-top">
                        ...
                        <button type="button" class="btn btn-default" onclick="window.location='teacher-list.aspx';">Cancel</button>
                    </div>
