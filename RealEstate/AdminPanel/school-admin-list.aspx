<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="school-admin-list.aspx.cs" Inherits="AdminPanel_SchoolAdmin_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHContent" runat="Server">
    <header class="page-title-bar">
        <div class="d-flex justify-content-between">
            <h1 class="page-title">Schools Admins List </h1>
            <div class="btn-toolbar">
                <button type="button" class="btn btn-primary" onclick="window.location.href='school-admin-modify.aspx'">Add School Admin</button>
            </div>
        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-alt">
                        ...
                        <div class="input-group has-clearable">
                            ...
                            <input id="table-search" type="text" class="form-control" placeholder="Search School Admin">
                        </div>
                        <!-- /.input-group -->
                    </div>
                    <!-- /.input-group -->
                ...
                <table id="myTable" class="table">
                    ...
                    <thead>
                        <tr>                           
                            ...
                            <th>Email Address </th>
                            <th>API Access? </th>
                             <th width="70" class="text-center">Account Type </th>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHFooter" runat="Server">
    ...
    <script type="text/javascript">
        ...
        var PageUrl = 'school-admin-list.aspx';
