<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="tenant-list.aspx.cs" Inherits="AdminPanel_School_List" %>
    ...
    <header class="page-title-bar">
        <div class="d-flex justify-content-between">
            ...
            <div class="btn-toolbar">
                <button type="button" class="btn btn-primary" onclick="window.location.href='tenant-modify.aspx'">Add Tenant</button>
            </div>
        </div>
                    ...
                    <div class="input-group input-group-alt">
                        ...
                        <div class="input-group-prepend">
                            <select id="filterBy" class="custom-select">
                                ...
                                <%-- <option value="1">Cases21 Code</option>--%>
                            </select>
                        </div>
                        <!-- /.input-group-prepend -->
                        <!-- .input-group -->
                        <div class="input-group has-clearable">
                            ...
                            <input id="table-search" type="text" class="form-control" placeholder="Search Tenant">
                        </div>
                        <!-- /.input-group -->
                    </div>
                    <!-- /.input-group -->
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHFooter" runat="Server">
    ...
    <script src="js/Page/datatables-school.js"></script>
