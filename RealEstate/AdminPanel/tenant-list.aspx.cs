...
public partial class AdminPanel_School_List : AdminAuthentication
{
    ...
    private void BindList()
    {
        ...
        dtblSchoolList = objSchool.GetList(ref CurrentPage, 10000, out intTotalRecord, SortColumn, SortType);
        data = JsonConvert.SerializeObject(dtblSchoolList, Formatting.Indented);

    }
    #endregion

    #region School Operation
    private void SchoolOperation()
    {
        ...
        objSchool.Operation(Convert.ToString(Request["hdnID"]), objOpr);
