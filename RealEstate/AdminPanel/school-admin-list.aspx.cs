...
public partial class AdminPanel_SchoolAdmin_List: AdminAuthentication
{
    ...
    private void BindList()
    {
        ...
        dt = objTeacher.SchoolAdminGetList( ref CurrentPage, 100000, out intTotalRecord, SortColumn, SortType);
    ...
    private void TeacherOperation()
    {
        ...
        objTeacher.Operation(Convert.ToString(Request["hdnID"]), objOpr, Convert.ToInt64(Session["UserID"]));
