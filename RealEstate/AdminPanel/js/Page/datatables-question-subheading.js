                ...
                columnDefs: [                    
                    {
                        ...
                        render: function render(data, type, row, meta) {
                            return "<a href=\"question-sub-heading-modify.aspx?qid=" + QuestionID + "&cid="+ CategoryID +"&id=" + row.ID + "\" class=\"mr-1\">" + row.SubHeading + "</a>";                            
                        }
                    },       
                    {
                        targets: 1,
                        render: function render(data, type, row, meta) {
                            return "<a href='sub-heading-skill-list.aspx?sid=" + row.ID + "&cid=" + CategoryID + "&qid=" + QuestionID + "' class='font17 qcount'>" + row.SkillCount + "</a>";
                        }
                    },
                    {
                        targets: 2,
                    ...
                    },
                    {
                        targets: 3,
                        render: function render(data, type, row, meta) {
                            return "<a data-toggle='tooltip' data-placement='bottom' title='Edit' class='btn btn-sm btn-icon btn-secondary' href='question-sub-heading-modify.aspx?qid=" + QuestionID + "&cid=" + CategoryID + "&id=" + row.ID + "'><i class=\"fa fa-pencil-alt\"></i></a>";                                
                        }
                    },
                    {
                        targets: 4,
