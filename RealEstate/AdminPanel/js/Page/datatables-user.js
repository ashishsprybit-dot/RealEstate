            ...
            var initDataTable = $('#myTable').DataTable({
                ...
                columnDefs: [
                    ...
                    //},
                    {
                        targets: 0,
                        render: function render(data, type, row, meta) {
                            return "<a href=\"admin-modify.aspx?id=" + row.ID + "\" class=\"mr-1\">" + getFullName(row) + "</a>";                            
                        }
                    },
                    {                        
                        targets: 3,
                    ...
                    },
                    {
                        targets: 4,
                        render: function render(data, type, row, meta) {                            
                            return "<a data-toggle='tooltip' data-placement='bottom' title='Edit' class='btn btn-sm btn-icon btn-secondary' href='admin-modify.aspx?id=" + row.ID + "'><i class=\"fa fa-pencil-alt\"></i></a>";                                
                        }
                    },
                    {
                        targets: 5,
