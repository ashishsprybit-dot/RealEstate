                ...
                columnDefs: [                    
                    {
                        ...
                        render: function render(data, type, row, meta) {
                            return "<a href=\"sub-heading-skill-modify.aspx?qid=" + QuestionID + "&cid=" + CategoryID + "&sid=" + SubHeadingID + "&id=" + row.ID + "\" class=\"mr-1\">" + row.Skill + "</a>";                            
                        }
                    },          
                    {
                        targets: 1,
                    ...
                    },
                    {
                        targets: 2,
                        render: function render(data, type, row, meta) {
                            return "<a data-toggle='tooltip' data-placement='bottom' title='Edit' class='btn btn-sm btn-icon btn-secondary' href='sub-heading-skill-modify.aspx?qid=" + QuestionID + "&cid=" + CategoryID + "&sid=" + SubHeadingID + "&id=" + row.ID + "'><i class=\"fa fa-pencil-alt\"></i></a>";                                
                        }
                    },
                    {
                        targets: 3,
