<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Admin.master" AutoEventWireup="true" CodeFile="tenant-admin-modify.aspx.cs"
    Inherits="AdminPanel_TenantAdmin_Modify" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHContent" runat="Server">
    <header class="page-title-bar">
        <h1 class="page-title"><span id="spnHeader" runat="server">Add Tenant Admin</span></h1>
    </header>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="<%=ddlSchool.ClientID%>">Tenant<abbr title="Required">*</abbr></label>
...
<%--
                    ...
                    <div class="card-body border-top">
                        ...
                        <button type="button" class="btn btn-default" onclick="window.location='tenant-admin-list.aspx';">Cancel</button>
                    </div>
