namespace BAL
{
    ...
    public class UserManagementBAL : UserManagementPAL
    {
        ...
        public DataTable GetByID()
        {
            ...
            return DbConnectionDAL.GetDataTable(CommandType.StoredProcedure, "TenantUserGetList", dbParam);
        }
        public DataTable GetByID(string SchoolURL)
        {
            DbParameter[] dbParam = new DbParameter[] {
                new DbParameter("@ID", DbParameter.DbType.Int, 20, base.ID),
                new DbParameter("@TenantURL", DbParameter.DbType.VarChar, 200, SchoolURL),
            };
            DataTable table = new DataTable();
            return DbConnectionDAL.GetDataTable(CommandType.StoredProcedure, "TenantUserGetList", dbParam);
        }
        ...
        
        {
            ...
            dbParam[9] = new DbParameter("@TenantURL", DbParameter.DbType.VarChar, 20, SchoolURL);

            DataTable table = new DataTable();
            table = DbConnectionDAL.GetDataTable(CommandType.StoredProcedure, "TenantUserGetList", dbParam);
        ...
        public void Operation(string Id, Common.DataBaseOperation ObjOperation, long UpdatedUserID)
        {
            ...
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "UserOperation", dbParam);
        }
        ...
        public int Save(long CreatedBy, string Pages, string assignedPageAccess, string SchoolURL)
        {
            DbParameter[] dbParam = new DbParameter[] {
                ...
                new DbParameter("@TenantURL", DbParameter.DbType.VarChar, 100, SchoolURL),
                new DbParameter("@ReturnVal", DbParameter.DbType.Int, 40, ParameterDirection.Output)
            };

            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "TenantUsersSave", dbParam);
