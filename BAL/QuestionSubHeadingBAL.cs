namespace BAL
{
    ...
    public class QuestionSubHeadingBAL : QuestionSubHeadingPAL
    {      
        public DataTable GetByID()
        {
            DbParameter[] dbParam = new DbParameter[] { 
                new DbParameter("@ID", DbParameter.DbType.Int, 200, base.ID)  ,
                 new DbParameter("@QuestionID", DbParameter.DbType.Int, 20, base.QuestionID)
            };
            DataTable table = new DataTable();
            return DbConnectionDAL.GetDataTable(CommandType.StoredProcedure, "QuestionSubHeadingsList", dbParam);
        }
        ...
        public DataTable GetList( ref int CurrentPage, int RecordPerPage, out int TotalRecord, string SortColumn, string SortType)
        {
            ...
            dbParam[6] = new DbParameter("@QuestionID", DbParameter.DbType.Int, 100, base.QuestionID);
            DataTable table = new DataTable();
            table = DbConnectionDAL.GetDataTable(CommandType.StoredProcedure, "QuestionSubHeadingsList", dbParam);
        ...
        public int Operation(string Id, Common.DataBaseOperation ObjOperation, int UserID)
        {
            ...
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "QuestionSubHeadingsOperation", dbParam);
        ...
        public int Save(long CreatedBy)
        {
            DbParameter[] dbParam = new DbParameter[] { 
                ...
                new DbParameter("@SubHeading", DbParameter.DbType.VarChar, 10000, base.SubHeading),                 
                new DbParameter("@QuestionID", DbParameter.DbType.Int, 500, base.QuestionID),
                new DbParameter("@ReturnVal", DbParameter.DbType.Int, 4, ParameterDirection.Output)                
            };

            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "QuestionSubHeadingsModify", dbParam);
            return Convert.ToInt32(dbParam[3].Value);
        }
        public void QuestionSubHeadingOrderChange(int QuestionID, string Sequence)
        {
            DbParameter[] dbParam = new DbParameter[] {
                new DbParameter("@QuestionID", DbParameter.DbType.Int, 20, QuestionID),
                new DbParameter("@Sequence", DbParameter.DbType.VarChar, 50000,Sequence)                
            };
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "QuestionSubHeadingOrderChange", dbParam);
