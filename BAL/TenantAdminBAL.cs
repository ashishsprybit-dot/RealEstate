namespace BAL
{
    ...
    public class TenantAdminBAL : TenantAdminPAL
    {
        ...
        public DataTable TenantAdminGetList(ref int CurrentPage, int RecordPerPage, out int TotalRecord, string SortColumn, string SortType)
        {
            ...
            DataTable table = new DataTable();
            table = DbConnectionDAL.GetDataTable(CommandType.StoredProcedure, "TenantAdminGetList", dbParam);
            CurrentPage = Convert.ToInt32(dbParam[4].Value);
            TotalRecord = Convert.ToInt32(dbParam[6].Value);
            return table;
        }
        public DataTable TenantAdminGetByID()
        {
            DbParameter[] dbParam = new DbParameter[] {
                new DbParameter("@ID", DbParameter.DbType.Int, 20, base.ID),
            };
            DataTable table = new DataTable();
            return DbConnectionDAL.GetDataTable(CommandType.StoredProcedure, "TenantAdminGetList", dbParam);
        }
        ...
        public void Operation(string Id, Common.DataBaseOperation ObjOperation, long UpdatedUserID)
        {
            ...
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "TenantAdminOperation", dbParam);
        }
        ...
        public int TenantAdminSave(long CreatedBy, string Pages, int Status, int IsAPIAccess)
        {
            DbParameter[] dbParam = new DbParameter[] {
                new DbParameter("@ID", DbParameter.DbType.Int, 20, base.ID),
                new DbParameter("@TenantID", DbParameter.DbType.Int, 20, base.SchoolID),
                new DbParameter("@FirstName", DbParameter.DbType.VarChar, 500, base.FirstName),
                new DbParameter("@LastName", DbParameter.DbType.VarChar, 500, base.LastName),
                new DbParameter("@EmailID", DbParameter.DbType.VarChar, 500, base.EmailID),
                new DbParameter("@Password", DbParameter.DbType.VarChar, 500, base.Password),
            ...
            DbConnectionDAL.ExecuteNonQuery(CommandType.StoredProcedure, "TenantAdminSave", dbParam);
            return Convert.ToInt32(dbParam[dbParam.Length - 1].Value);
        }
